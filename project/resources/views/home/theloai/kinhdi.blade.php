...
<head>
    <meta charset="utf-8">
    <title>Phim Kinh Dị | MovieReview </title>
...
<body class="bg-dark text-white">
                                ...
                                <div class="dropdown-menu bg-success border-0 rounded-0 m-0">
                                    <div class="d-flex p-2">
                                        <div class="col-6">
                                            ...
                                            <a href="{{ route('kinhdi') }}" class="dropdown-item active">Kinh dị</a>
    ...
    <div class="container-fluid bg-dark p-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-3 text-success mb-4"><i class="fas fa-ghost me-3"></i>Phim Thể Loại Kinh Dị</h1>
            <p class="text-light fs-5">Những bài đánh giá chuyên sâu về các bộ phim kinh dị, rùng rợn và giật gân mới nhất trên toàn thế giới.</p>
        </div>
    </div>
            ...
            <div class="tab-class">
                <div class="row g-4 mb-5">
                    <div class="col-12 text-center wow fadeIn" data-wow-delay="0.1s">
                        <h2 class="text-success">Phim Kinh Dị Cực Hot</h2>
                    </div>
                </div>
                                ...
                                <div class="product-item rounded wow fadeInUp bg-dark border border-success" data-wow-delay="0.1s">
                                    <div class="product-item-inner border-0 rounded">
                                        ...
                                        <div class="text-center rounded-bottom p-4 bg-black">
                                            ...
                                            <a href="#" class="d-block h4 text-white">Phim Làm Giàu Với Ma <br> (Phim Việt)</a>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp bg-dark border border-success" data-wow-delay="0.3s">
                                    <div class="product-item-inner border-0 rounded">
                                        ...
                                        <div class="text-center rounded-bottom p-4 bg-black">
                                            <a href="#" class="d-block mb-2 text-success">Kinh Dị - Ma</a>
                                            <a href="#" class="d-block h4 text-white">Phim The Conjuring 3 <br> (Phim Mỹ)</a>
                                            <span class="me-2 fs-5 text-light">2021</span>
                                            <span class="text-success fs-5">⭐ 8.7/10</span>
                                        </div>
                                    </div>
                                    <div
                                        class="product-item-add border border-top-0 border-success rounded-bottom  text-center p-4 pt-0">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp bg-dark border border-success" data-wow-delay="0.5s">
                                    <div class="product-item-inner border-0 rounded">
                                        ...
                                        <div class="text-center rounded-bottom p-4 bg-black">
                                            <a href="#" class="d-block mb-2 text-success">Kinh Dị - Ghi Hình</a>
                                            <a href="#" class="d-block h4 text-white">Phim Incantation <br> (Phim Đài Loan)</a>
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp bg-dark border border-success" data-wow-delay="0.7s">
                                    <div class="product-item-inner border-0 rounded">
                                        ...
                                        <div class="text-center rounded-bottom p-4 bg-black">
                                            <a href="#" class="d-block mb-2 text-success">Kinh Dị - Tâm Lý</a>
                                            <a href="#" class="d-block h4 text-white">Phim Smile <br> (Phim Mỹ)</a>
                                            <span class="me-2 fs-5 text-light">2022</span>
                                            <span class="text-success fs-5">⭐ 9.2/10</span>
                                        </div>
                                    </div>
                                    <div
                                        class="product-item-add border border-top-0 border-success rounded-bottom  text-center p-4 pt-0">
