    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            ...
            <form action="{{ route('admin.category.update', ['category' => $category->id]) }}" method="POST">
                ...
                <a href="{{ route('admin.category.index')}}" class="btn btn-secondary mt-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-return-left" viewBox="0 0 16 16">
